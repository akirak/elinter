...
elinter -b
#+end_src
*** Use case #2: Run lint on the latest snapshot in the remote repository
This is like the use case 1, but it clones a remote repository specified in the recipe instead of working on source files in the working directory.
