* elinter
This is a complete rewrite of my Emacs Lisp package checker, formerly called =emacs-package-checker= or =melpa-check=. It is currently at an alpha stage, and even half of its planned features are not implemented yet.
** Design goals
