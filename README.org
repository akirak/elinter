...
** Credits
- The linting logics are partly based on [[https://github.com/alphapapa/makem.sh][makem.sh]] by alphapapa (Adam Porter) and [[https://gitea.petton.fr/DamienCassou/makel][makel]] by Damien Cassou.
...
- The PureScript source code follows some articles and examples written by [[https://github.com/justinwoo/][Justin Woo]].
- The idea of using =niv= for dependency management is an inspiration from [[https://github.com/purcell/setup-emacs/][setup-emacs]] by Steve Purcell. The GitHub action in the external repository is also roughly based on his work.

And thank you for other contributors, including Eric Dallo ([[https://github.com/ericdallo][@ericdallo]]) and Terje Larsen ([[https://github.com/terlar][@terlar]])!
** License
GPL v3
