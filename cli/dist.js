...
(function($PS) {
  ...
  var showCommand = function (cmd) {
      return function (args) {
          return Data_String_Common.joinWith(" ")(Data_Functor.map(Data_Functor.functorArray)(quoteMaybe)(Data_Array.cons(cmd)(args)));
      };
  };
  ...
  var parseNixConf = (function () {
      ...
      var parseEntry = function (l) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_Regex.match(regexp)(l))((function () {
              ...
              return function ($39) {
                  return $38(Data_Array_NonEmpty.toArray($39));
              };
          })()))(function (a) {
      ...
      var $40 = Data_Array.mapMaybe(parseEntry);
      var $41 = Data_String_Common.split("\x0a");
      return function ($42) {
          return $40($41($42));
      };
  })();
      ...
      return function (dest) {
          return function __do() {
              ...
              var linkType = (function () {
                  var $11 = Node_FS_Stats.isFile(stat);
                  if ($11) {
  ...
  var getSubstituters = (function () {
      ...
      var $44 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split(" "));
      var $45 = lookupConf("substituters");
      return function ($46) {
          return $43($44($45($46)));
      };
  })();
  var getProcessOutput = function (cmd) {
      return function (args) {
          var stdio = Data_Maybe.fromJust()(Data_Array.updateAt(1)(new Data_Maybe.Just(Node_ChildProcess.Pipe.value))(Node_ChildProcess.inherit));
          return Control_Bind.bind(Effect_Aff.bindAff)(Effect_Aff.makeAff(function (cb) {
              return function __do() {
                  ...
                  Node_Stream.onDataString(Node_ChildProcess.stdout(p))(Node_Encoding.UTF8.value)(function (s) {
                      return Effect_Ref.modify_(function (v) {
                          return v + s;
                      })(stdoutRef);
                  })();
                  Node_ChildProcess.onError(p)(function ($47) {
                      return cb(Data_Either.Left.create(Node_ChildProcess.toStandardError($47)));
                  })();
                  Node_ChildProcess.onExit(p)(function (exit) {
                      return function __do() {
                          var stdout = Effect_Ref.read(stdoutRef)();
                          return cb(Data_Either.Right.create({
                              stdout: stdout,
                              exit: exit
                          }))();
                      };
              ...
              if (v.exit instanceof Node_ChildProcess.Normally && v.exit.value0 === 0) {
                  return Control_Applicative.pure(Effect_Aff.applicativeAff)(v.stdout);
              };
              if (v.exit instanceof Node_ChildProcess.Normally) {
                  return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error("Exit code " + (Data_Show.show(Data_Show.showInt)(v.exit.value0) + (" from command \"" + (showCommand(cmd)(args) + "\"")))));
              };
              return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error(Data_Show.show(Node_ChildProcess.showExit)(v.exit) + (" from command " + showCommand(cmd)(args))));
          });
      };
  };
  var getProcessOutputAsJson = function (dictDecode) {
      return function (cmd) {
          return function (args) {
              return Control_Bind.bind(Effect_Aff.bindAff)(getProcessOutput(cmd)(args))(function (raw) {
                  var r = Control_Monad_Except.runExcept(Foreign_Generic.decodeJSON(dictDecode)(raw));
                  if (r instanceof Data_Either.Left) {
                      return Control_Monad_Error_Class.throwError(Effect_Aff.monadThrowAff)(Effect_Exception.error(Data_Show.show(Data_List_Types.showNonEmptyList(Foreign.showForeignError))(r.value0)));
                  };
  ...
  exports["getProcessOutputAsJson"] = getProcessOutputAsJson;
...
(function($PS) {
          ...
          return function (mOptions) {
              return function (v) {
                  return function (v1) {
                      ...
                      })(v) + (" -A " + (expName + ("." + Data_Maybe.fromMaybe("default")(v1))))));
                  };
              };
          };
      };
  ...
  exports["ertCommand"] = ertCommand;
  exports["ertRunnerCommand"] = ertRunnerCommand;
...
(function($PS) {
  ...
  var runTest = function (opts) {
      return function (mPackage) {
          return Lib.runInNixShell([ Lib.testCommand(opts.emacsVersion)(mPackage) ]);
      };
  };
  ...
  var runErtRunner = function (opts) {
      return function (mPackage) {
          return Lib.runInNixShell([ Lib.ertRunnerCommand(opts.emacsVersion)(mPackage) ]);
      };
  };
  var runErt = function (opts) {
      return function (mPackage) {
          return Lib.runInNixShell([ Lib.ertCommand(opts.emacsVersion)(mPackage) ]);
      };
  };
  ...
  var listPackages = function __do() {
      ...
      return Effect_Aff.runAff_(Utils.exitOnError)(Control_Bind.bind(Effect_Aff.bindAff)(Utils.getProcessOutputAsJson(Foreign_Generic_Class.arrayDecode(Foreign_Generic_Class.stringDecode))("nix-instantiate")([ "--eval", "-A", "packageNames", "--strict", "--json", configPath ]))(function (v) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Foldable.sequence_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Effect_Console.log)(v)));
      }))();
  };
  var listEmacsVersions = function __do() {
      var configPath = Lib.getConfigPath();
      return Effect_Aff.runAff_(Utils.exitOnError)(Control_Bind.bind(Effect_Aff.bindAff)(Utils.getProcessOutputAsJson(Foreign_Generic_Class.arrayDecode(Foreign_Generic_Class.stringDecode))("nix-instantiate")([ "--eval", "-A", "emacsVersions", "--strict", "--json", configPath ]))(function (v) {
          return Effect_Class.liftEffect(Effect_Aff.monadEffectAff)(Data_Foldable.sequence_(Effect.applicativeEffect)(Data_Foldable.foldableArray)(Data_Functor.map(Data_Functor.functorArray)(Effect_Console.log)(v)));
      }))();
  };
  var installDeps = (function () {
      ...
      return function __do() {
          ...
          var nixConfFile = Node_Path.concat([ home, ".config", "nix", "nix.conf" ]);
          return Control_Monad.whenM(Effect.monadEffect)(Utils.doesFileExist(nixConfFile))(Utils.logTextFileContent(nixConfFile))();
      };
  })();
  var checkConfig = function (opts) {
      return function __do() {
          (function () {
              ...
              throw new Error("Failed pattern match at Commands (line 61, column 3 - line 65, column 25): " + [ opts.configFile.constructor.name ]);
          })();
          var configPath = Lib.getConfigPath();
  ...
  exports["runErt"] = runErt;
  exports["runErtRunner"] = runErtRunner;
  exports["runTest"] = runTest;
  exports["listEmacsVersions"] = listEmacsVersions;
...
(function($PS) {
  ...
  var opts = (function () {
      ...
      var ertOpts = Record_Extra.sequenceRecord()(Record_Extra.sequenceRecordSingle(new Data_Symbol.IsSymbol(function () {
          return "emacsVersion";
      }))()(Options_Applicative_Types.parserFunctor)()())({
          emacsVersion: emacsArg
      });
      var ertRunnerOpts = Record_Extra.sequenceRecord()(Record_Extra.sequenceRecordSingle(new Data_Symbol.IsSymbol(function () {
          return "emacsVersion";
      }))()(Options_Applicative_Types.parserFunctor)()())({
          emacsVersion: emacsArg
      });
      ...
      var testOpts = Record_Extra.sequenceRecord()(Record_Extra.sequenceRecordSingle(new Data_Symbol.IsSymbol(function () {
          return "emacsVersion";
      }))()(Options_Applicative_Types.parserFunctor)()())({
          emacsVersion: emacsArg
      });
