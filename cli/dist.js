...
(function($PS) {
  ...
  $PS["Lib"] = $PS["Lib"] || {};
  var exports = $PS["Lib"];
  var emacsCiUrl = "https://github.com/purcell/nix-emacs-ci/archive/master.tar.gz";
  var emacsCiChannelName = "emacs-ci";
  exports["emacsCiChannelName"] = emacsCiChannelName;
  exports["emacsCiUrl"] = emacsCiUrl;
})(PS);
(function(exports) {
  "use strict";
...
(function($PS) {
  ...
  var parseNixConf = (function () {
      ...
      var parseEntry = function (l) {
          return Control_Bind.bind(Data_Maybe.bindMaybe)(Control_Bind.bind(Data_Maybe.bindMaybe)(Data_String_Regex.match(regexp)(l))((function () {
              var $15 = Control_Applicative.pure(Data_Maybe.applicativeMaybe);
              return function ($16) {
                  return $15(Data_Array_NonEmpty.toArray($16));
              };
          })()))(function (a) {
      ...
      var $17 = Data_Array.mapMaybe(parseEntry);
      var $18 = Data_String_Common.split("\x0a");
      return function ($19) {
          return $17($18($19));
      };
  })();
  ...
  var getSubstituters = (function () {
      var $20 = Data_Maybe.fromMaybe([  ]);
      var $21 = Data_Functor.map(Data_Maybe.functorMaybe)(Data_String_Common.split(" "));
      var $22 = lookupConf("substituters");
      return function ($23) {
          return $20($21($22($23)));
      };
  })();
  var getPathDirectories = function __do() {
      ...
      throw new Error("Failed pattern match at Utils (line 77, column 3 - line 79, column 55): " + [ mPath.constructor.name ]);
  };
  var getHomeDirectory = function __do() {
      ...
      throw new Error("Failed pattern match at Utils (line 137, column 3 - line 139, column 69): " + [ mHome.constructor.name ]);
  };
  var getNixChannels = function __do() {
      var home = getHomeDirectory();
      return Data_Functor.map(Effect.functorEffect)(Data_String_Common.split("\x0a"))(Node_FS_Sync.readTextFile(Node_Encoding.UTF8.value)(Node_Path.concat([ home, ".nix-channels" ])))();
  };
  var getNixConfFile = function __do() {
      ...
      throw new Error("Failed pattern match at Utils (line 128, column 3 - line 132, column 64): " + [ xdgConf.constructor.name ]);
  };
  ...
  var findExecutable = function (program) {
      var go = function (mPath) {
          return function (dir) {
              ...
              throw new Error("Failed pattern match at Utils (line 53, column 18 - line 62, column 21): " + [ mPath.constructor.name ]);
          };
      };
      var $13 = Node_Path.isAbsolute(program);
      if ($13) {
          return function __do() {
  ...
  exports["getNixChannels"] = getNixChannels;
...
(function($PS) {
  ...
  var installDeps = (function () {
      ...
      return function __do() {
          ...
          var nixChannels = Utils.getNixChannels();
          var hasEmacsCi = Data_Foldable.elem(Data_Foldable.foldableArray)(Data_Eq.eqString)(Lib.emacsCiUrl + (" " + Lib.emacsCiChannelName))(nixChannels);
          Control_Applicative.unless(Effect.applicativeEffect)(hasEmacsCi)(function __do() {
              Utils.callProcess("nix-channel")([ "--add", Lib.emacsCiUrl, Lib.emacsCiChannelName ])();
              return Utils.callProcess("nix-channel")([ "--update" ])();
          })();
          Effect_Console.log("==================================================")();
          ...
          Utils.logTextFileContent(Node_Path.concat([ home, ".nix-channels" ]))();
...
(function($PS) {
  ...
  var Options_Applicative_Types = $PS["Options.Applicative.Types"];                
  var opts = Options_Applicative_Builder.subparser(Options_Applicative_Builder.command("deps")(Options_Applicative_Builder.info(Control_Applicative.pure(Options_Applicative_Types.parserApplicative)(Commands.installDeps))(Options_Applicative_Builder.progDesc("Install dependencies"))));
  var main = Control_Bind.join(Effect.bindEffect)(Options_Applicative_Extra.execParser(Options_Applicative_Builder.info(Control_Apply.apply(Options_Applicative_Types.parserApply)(Options_Applicative_Extra.helper)(opts))(Options_Applicative_Builder.idm(Options_Applicative_Builder.infoModMonoid))));
  exports["main"] = main;
  exports["opts"] = opts;
})(PS);
PS["Main"].main();